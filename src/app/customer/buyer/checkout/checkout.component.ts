...
export class CheckoutComponent implements OnInit {
  ...
  placeOrder() {
    this.order_dto = {
      id: 0,
      userId: this.user_id,
      sellerId: this.user_id, //Now it is hard coded, we are not implimented multi seller functionlity
      product: {
        ...
        gen: this.individual_product.gen,
        type: this.individual_product.type,
        idCategory: this.individual_product.idCategory, 
